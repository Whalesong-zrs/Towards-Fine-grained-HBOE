...
from .head_block import OEHeadBlock
# from head_block import OEHeadBlock
BN_MOMENTUM = 0.1
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.down1 = self._make_layer(BasicBlock, 128, 2, stride=2)
        self.OEhead1_1 = OEHeadBlock(in_features=128, out_features=128, num_heads=4)
        self.down2 = self._make_layer(BasicBlock, 256, 2, stride=2)
        self.OEhead2_1 = OEHeadBlock(in_features=256, out_features=256, num_heads=8)
        self.down3 = self._make_layer(BasicBlock, 512, 2, stride=2)
...
if __name__ == "__main__":
    ...
    args.cfg = "experiments_yaml/hrnet_head.yaml"
